...
const isAllSelected = computed(() => {
    return (
        selectedProductIds.value.length === products.data.length &&
...
<template>
    ...
    <ConfirmationDialog
        :is-open="isDialogOpen.single"
        title="Are you sure ?"
        message="This action can't be undone."
        @confirm="handleDelete"
        @cancel="isDialogOpen.single = false"
    />

    <ConfirmationDialog
        :is-open="isDialogOpen.bulk"
        title="Are you sure ?"
        message="This action can't be undone."
        @confirm="handleBulkDelete"
        @cancel="isDialogOpen.bulk = false"
    />
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-6">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div
                    class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center gap-2 pb-6"
                    :class="{
                        'justify-between': selectedProductIds.length,
                        'justify-end': !selectedProductIds.length,
                    }"
                >
                    <div v-show="selectedProductIds.length" class="space-x-3">
                        <button
                            @click="isDialogOpen.bulk = true"
